...
# model = init_chat_model("claude-haiku-4-5", timeout=60, max_retries=2)
model = init_chat_model("gpt-5-nano", timeout=60, max_retries=2)

#A more capable model for steps that need stronger reasoning
# strong_model = init_chat_model("claude-sonnet-4-6", timeout=120, max_retries=2)
strong_model = init_chat_model("claude-haiku-4-5", timeout=120, max_retries=2)
